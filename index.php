...
<body>
					...
					<div class="offset-md-2 col-8">
						<form class="contact100-form validate-form" method="post" action="connect.php">
							...
							<div class="d-flex justify-content-center mt-3 login_container">
					   		...
					   		<div class="d-flex justify-content-center mt-3 login_container">
					   		    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalMdp">Voir les mots de passe</button>
					   		</div>
						</form>
					</div>
	...
	<div id="modalMdp" class="modal fade" role="dialog">
