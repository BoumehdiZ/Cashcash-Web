    ...
    <div class="wrap-contact100">
        ...
        <form class="contact100-form validate-form" method="post">
            ...
            <!-- Button trigger modal -->
                        <button type="submit" class="btn btn-success" name="modal" data-toggle="modal" data-target="#modal">
                            Valider
                        </button>
                </div>
            </div>
            ...
            <!-- Modal -->
            <div class="modal fade" id="modal" tabindex="-1" role="dialog" data-keyborad="false" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Statistique pour le mois<?php
                                switch ($_POST['mois']) {
                                    case 1:
                                        echo " de janvier";
                                        break;
                            ...
                            <button onclick ="location.href='stat_A.php'" type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            Technicien : <?php echo $nom_technicien." ".$prenom_technicien; ?>
                            <br>
                            <br>
                        ...
                        <div class="modal-footer">
                            <button onclick ="location.href='stat_A.php'" type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                        </div>
                    </div>
                </div>
            </div>
